    ...
    <div class="flex flex-col gap-5 items-center">
        <div class="mx-auto my-5 flex flex-col gap-10 items-center max-w-6xl bg-gray-100 rounded-3xl p-10 ">
            ...
            <form @submit.prevent=""
                ...
                <div class=" relative col-span-2 row-span-1 sm:row-span-1 sm:col-span-1 min-h-full border-b-2 ">
                    <input type="text" name="shift" id="shift"
                        ...
                        min="0" v-model="shift">
                    <div
                        class="grid grid-flow-col sm:grid-flow-row h-full  font-bold text-2xl absolute right-0 top-0 divide-x-2 md:divide-x-0 md:divide-y-2 ">
            ...
            <div class="flex flex-col ">
                <span class="font-medium text-xl text-slate-900 text-center ">{{ !option ? 'Decrypt?' : 'Encrypt?'
                }}</span>
                <label class="relative inline-flex items-center cursor-pointer rounded-full shadow-lg">
                    ...
                    <div class=" w-28 h-14 shadow-inner bg-green-600 peer-focus:outline-none peer-focus:ring-4
                         peer-focus:ring-blue-300  rounded-full peer peer-checked:after:translate-x-full 
                         peer-checked:after:border-white after:content-[''] after:absolute after:top-[3px]  after:left-[6px]  after:bg-white
                          after:border-gray-300 after:border after:rounded-full after:h-[50px] after:w-[50px] after:transition-all
                           border-gray-600 peer-checked:bg-red-600">
                    </div>
                </label>
            </div>
            <div class=" w-full flex flex-col gap-5">
                ...
                <p class="bg-white rounded-3xl p-5 text-slate-600 font-semibold text-lg shadow-sm">{{
                    result? result:
                        'Result goes here'
                }}
                </p>
